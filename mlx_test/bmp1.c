...
/*   Updated: 2021/03/15 18:24:42 by rburton          ###   ########.fr       */
/*                                                                            */
/* ************************************************************************** */
...
{
    src[0] = (unsigned char)(n); //gets blue
    src[1] = (unsigned char)(n >> 8); //gets green
    src[2] = (unsigned char)(n >> 16); //gets red
    src[3] = (unsigned char)(n >> 24); //gets transparent
}
